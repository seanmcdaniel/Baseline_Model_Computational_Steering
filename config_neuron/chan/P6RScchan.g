...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaF13  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF13  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF13  X_A->table[{i}] {y}
            setfield NaF13  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF13  Y_A->table[{i}] {y}
            setfield NaF13  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF13  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF13  TABFILL X 3000 0

        setfield NaF13  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF13  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaP13 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP13 X_A->table[{i}] {y}
            setfield NaP13 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP13  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP13  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call AR13 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR13 X_A->table[{i}] {y}
            setfield AR13 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR13 X_A->calc_mode 0   X_B->calc_mode 0
        call AR13 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KDR13 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR13 X_A->table[{i}] {y}
            setfield KDR13 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR13 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR13 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KA13 TABCREATE X {xdivs} {xmin} {xmax}
    call KA13 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA13 X_A->table[{i}] {y}
            setfield KA13 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA13 Y_A->table[{i}] {y}
            setfield KA13 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA13 X_A->calc_mode 0   X_B->calc_mode 0
        call KA13 TABFILL X 3000 0

        setfield KA13 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA13 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call K213 TABCREATE X {xdivs} {xmin} {xmax}
    call K213 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K213 X_A->table[{i}] {y}
            setfield K213 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K213 Y_A->table[{i}] {y}
            setfield K213 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K213 X_A->calc_mode 0   X_B->calc_mode 0
        call K213 TABFILL X 3000 0

        setfield K213 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K213 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KM13 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM13 X_A->table[{i}] {y}
            setfield KM13 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM13 X_A->calc_mode 0   X_B->calc_mode 0
        call KM13 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaL13 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL13 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL13 X_A->table[{i}] {y}
            setfield CaL13 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL13 Y_A->table[{i}] {y}
            setfield CaL13 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL13 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL13 TABFILL X 3000 0

        setfield CaL13 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL13 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaH13 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH13 X_A->table[{i}] {y}
            setfield CaH13 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH13 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH13 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCs13 TABCREATE X {xdivs} {xmin} {xmax}
        int i
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCs13 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs13 Xpower 1
    call KCs13 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs13 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCs13 Z_A->table[{i}] {y}
            setfield KCs13 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCs13 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs13 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs13 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs13 TABFILL Z 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCd13 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCd13 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd13 Xpower 1
    call KCd13 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd13 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd13 Z_A->table[{i}] {y}
            setfield KCd13 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCd13 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd13 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd13 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd13 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs13 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs13 Z_A->table[{i}] {y}
            setfield KAHPs13 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs13 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs13 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd13 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd13 Z_A->table[{i}] {y}
            setfield KAHPd13 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd13 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd13 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

...
float ENAP5IBc = 0.115 + EREST_ACT // 0.055
float EKP5IBc = -0.015 + EREST_ACT // -0.075
float ECAP5IBc = 0.140 + EREST_ACT // 0.080
float EARP5IBc = 0.025 + EREST_ACT // -0.035
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        int     xdivs = 79
    call NaF8  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF8  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF8  X_A->table[{i}] {y}
            setfield NaF8  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF8  Y_A->table[{i}] {y}
            setfield NaF8  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF8  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF8  TABFILL X 3000 0

        setfield NaF8  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF8  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call NaP8 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP8 X_A->table[{i}] {y}
            setfield NaP8 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP8  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP8  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call AR8 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR8 X_A->table[{i}] {y}
            setfield AR8 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR8 X_A->calc_mode 0   X_B->calc_mode 0
        call AR8 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call KDR8 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR8 X_A->table[{i}] {y}
            setfield KDR8 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR8 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR8 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call KA8 TABCREATE X {xdivs} {xmin} {xmax}
    call KA8 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA8 X_A->table[{i}] {y}
            setfield KA8 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA8 Y_A->table[{i}] {y}
            setfield KA8 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA8 X_A->calc_mode 0   X_B->calc_mode 0
        call KA8 TABFILL X 3000 0

        setfield KA8 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA8 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call K28 TABCREATE X {xdivs} {xmin} {xmax}
    call K28 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K28 X_A->table[{i}] {y}
            setfield K28 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K28 Y_A->table[{i}] {y}
            setfield K28 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K28 X_A->calc_mode 0   X_B->calc_mode 0
        call K28 TABFILL X 3000 0

        setfield K28 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K28 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call KM8 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM8 X_A->table[{i}] {y}
            setfield KM8 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM8 X_A->calc_mode 0   X_B->calc_mode 0
        call KM8 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call CaL8 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL8 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL8 X_A->table[{i}] {y}
            setfield CaL8 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL8 Y_A->table[{i}] {y}
            setfield CaL8 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL8 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL8 TABFILL X 3000 0

        setfield CaL8 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL8 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call CaH8 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH8 X_A->table[{i}] {y}
            setfield CaH8 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH8 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH8 TABFILL X 3000 0
...
// Now make a X-table for the voltage-dependent activation parameter.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
        call KCs8 TABCREATE X {xdivs} {xmin} {xmax}
        int i
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCs8 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs8 Xpower 1
    call KCs8 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs8 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCs8 Z_A->table[{i}] {y}
            setfield KCs8 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCs8 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs8 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs8 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs8 TABFILL Z 3000 0
...
// Now make a X-table for the voltage-dependent activation parameter.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
        call KCd8 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCd8 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd8 Xpower 1
    call KCd8 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd8 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd8 Z_A->table[{i}] {y}
            setfield KCd8 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCd8 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd8 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd8 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd8 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs8 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs8 Z_A->table[{i}] {y}
            setfield KAHPs8 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs8 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs8 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd8 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd8 Z_A->table[{i}] {y}
            setfield KAHPd8 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd8 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd8 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        int     xdivs = 79
    call NaF23  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF23  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF23  X_A->table[{i}] {y}
            setfield NaF23  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF23  Y_A->table[{i}] {y}
            setfield NaF23  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF23  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF23  TABFILL X 3000 0

        setfield NaF23  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF23  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call NaP23 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP23 X_A->table[{i}] {y}
            setfield NaP23 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP23  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP23  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call AR23 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR23 X_A->table[{i}] {y}
            setfield AR23 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR23 X_A->calc_mode 0   X_B->calc_mode 0
        call AR23 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call KDR23 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR23 X_A->table[{i}] {y}
            setfield KDR23 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR23 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR23 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call KA23 TABCREATE X {xdivs} {xmin} {xmax}
    call KA23 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA23 X_A->table[{i}] {y}
            setfield KA23 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA23 Y_A->table[{i}] {y}
            setfield KA23 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA23 X_A->calc_mode 0   X_B->calc_mode 0
        call KA23 TABFILL X 3000 0

        setfield KA23 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA23 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call K223 TABCREATE X {xdivs} {xmin} {xmax}
    call K223 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K223 X_A->table[{i}] {y}
            setfield K223 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K223 Y_A->table[{i}] {y}
            setfield K223 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K223 X_A->calc_mode 0   X_B->calc_mode 0
        call K223 TABFILL X 3000 0

        setfield K223 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K223 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
    call KM23 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM23 X_A->table[{i}] {y}
            setfield KM23 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM23 X_A->calc_mode 0   X_B->calc_mode 0
        call KM23 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call CaL23 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL23 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL23 X_A->table[{i}] {y}
            setfield CaL23 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL23 Y_A->table[{i}] {y}
            setfield CaL23 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL23 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL23 TABFILL X 3000 0

        setfield CaL23 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL23 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        float   xmax = 0.10  // normally  0.05
        int     xdivs = 79
    call CaH23 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH23 X_A->table[{i}] {y}
            setfield CaH23 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH23 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH23 TABFILL X 3000 0
...
// Now make a X-table for the voltage-dependent activation parameter.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
        call KCs23 TABCREATE X {xdivs} {xmin} {xmax}
        int i
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCs23 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs23 Xpower 1
    call KCs23 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs23 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCs23 Z_A->table[{i}] {y}
            setfield KCs23 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCs23 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs23 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs23 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs23 TABFILL Z 3000 0
...
// Now make a X-table for the voltage-dependent activation parameter.
        ...
        float   xmax = 0.10   // normally  0.05
        int     xdivs = 79
        call KCd23 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
...
// Expand the tables to 3000 entries to use without interpolation
    setfield KCd23 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd23 Xpower 1
    call KCd23 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd23 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd23 Z_A->table[{i}] {y}
            setfield KCd23 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCd23 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd23 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd23 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd23 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs23 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs23 Z_A->table[{i}] {y}
            setfield KAHPs23 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs23 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs23 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd23 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd23 Z_A->table[{i}] {y}
            setfield KAHPd23 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd23 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd23 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

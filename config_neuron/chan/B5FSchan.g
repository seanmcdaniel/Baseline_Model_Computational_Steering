...
float ENAB5FS = 0.110 + EREST_ACT // 0.050
float EKB5FS = -0.040 + EREST_ACT // -0.100
float ECAB5FS = 0.185 + EREST_ACT // 0.125
float EARB5FS = 0.025 + EREST_ACT // -0.035
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaF10  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF10  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF10  X_A->table[{i}] {y}
            setfield NaF10  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF10  Y_A->table[{i}] {y}
            setfield NaF10  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF10  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF10  TABFILL X 3000 0

        setfield NaF10  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF10  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaP10 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP10 X_A->table[{i}] {y}
            setfield NaP10 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP10  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP10  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call AR10 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR10 X_A->table[{i}] {y}
            setfield AR10 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR10 X_A->calc_mode 0   X_B->calc_mode 0
        call AR10 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KDR10 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR10 X_A->table[{i}] {y}
            setfield KDR10 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR10 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR10 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KA10 TABCREATE X {xdivs} {xmin} {xmax}
    call KA10 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA10 X_A->table[{i}] {y}
            setfield KA10 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA10 Y_A->table[{i}] {y}
            setfield KA10 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA10 X_A->calc_mode 0   X_B->calc_mode 0
        call KA10 TABFILL X 3000 0

        setfield KA10 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA10 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call K210 TABCREATE X {xdivs} {xmin} {xmax}
    call K210 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K210 X_A->table[{i}] {y}
            setfield K210 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K210 Y_A->table[{i}] {y}
            setfield K210 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K210 X_A->calc_mode 0   X_B->calc_mode 0
        call K210 TABFILL X 3000 0

        setfield K210 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K210 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KM10 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM10 X_A->table[{i}] {y}
            setfield KM10 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM10 X_A->calc_mode 0   X_B->calc_mode 0
        call KM10 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaL10 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL10 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL10 X_A->table[{i}] {y}
            setfield CaL10 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL10 Y_A->table[{i}] {y}
            setfield CaL10 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL10 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL10 TABFILL X 3000 0

        setfield CaL10 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL10 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaH10 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH10 X_A->table[{i}] {y}
            setfield CaH10 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH10 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH10 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCs10 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCs10 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCs10 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs10 Xpower 1
    call KCs10 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs10 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
           ...
           setfield KCs10 Z_A->table[{i}] {y}
           setfield KCs10 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCs10 Z_A->table[{i}] {y/2}
            //setfield KCs10 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCs10 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs10 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs10 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs10 TABFILL Z 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCd10 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCd10 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCd10 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd10 Xpower 1
    call KCd10 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd10 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd10 Z_A->table[{i}] {y}
            setfield KCd10 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCd10 Z_A->table[{i}] {y/2}
            //setfield KCd10 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCd10 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd10 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd10 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd10 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs10 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs10 Z_A->table[{i}] {y}
            setfield KAHPs10 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs10 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs10 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd10 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd10 Z_A->table[{i}] {y}
            setfield KAHPd10 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd10 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd10 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

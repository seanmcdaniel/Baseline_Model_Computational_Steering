...
float ENAP6RSa = 0.115 + EREST_ACT // 0.055
float EKP6RSa = -0.015 + EREST_ACT // -0.075
float ECAP6RSa = 0.140 + EREST_ACT // 0.080
float EARP6RSa = 0.025 + EREST_ACT // -0.035
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaF11  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF11  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF11  X_A->table[{i}] {y}
            setfield NaF11  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF11  Y_A->table[{i}] {y}
            setfield NaF11  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF11  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF11  TABFILL X 3000 0

        setfield NaF11  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF11  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaP11 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP11 X_A->table[{i}] {y}
            setfield NaP11 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP11  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP11  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call AR11 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR11 X_A->table[{i}] {y}
            setfield AR11 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR11 X_A->calc_mode 0   X_B->calc_mode 0
        call AR11 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KDR11 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR11 X_A->table[{i}] {y}
            setfield KDR11 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR11 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR11 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KA11 TABCREATE X {xdivs} {xmin} {xmax}
    call KA11 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA11 X_A->table[{i}] {y}
            setfield KA11 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA11 Y_A->table[{i}] {y}
            setfield KA11 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA11 X_A->calc_mode 0   X_B->calc_mode 0
        call KA11 TABFILL X 3000 0

        setfield KA11 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA11 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call K211 TABCREATE X {xdivs} {xmin} {xmax}
    call K211 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K211 X_A->table[{i}] {y}
            setfield K211 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K211 Y_A->table[{i}] {y}
            setfield K211 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K211 X_A->calc_mode 0   X_B->calc_mode 0
        call K211 TABFILL X 3000 0

        setfield K211 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K211 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KM11 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM11 X_A->table[{i}] {y}
            setfield KM11 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM11 X_A->calc_mode 0   X_B->calc_mode 0
        call KM11 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaL11 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL11 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL11 X_A->table[{i}] {y}
            setfield CaL11 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL11 Y_A->table[{i}] {y}
            setfield CaL11 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL11 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL11 TABFILL X 3000 0

        setfield CaL11 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL11 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaH11 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH11 X_A->table[{i}] {y}
            setfield CaH11 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH11 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH11 TABFILL X 3000 0
...
****************************************************************************/
function make_Ca_s11
        if ({exists Ca_s11})
                return
        end
        create Ca_concen Ca_s11
        setfield Ca_s11 \
                tau     0.050   \      // sec (nl .050)
                B       17.402e12 \      // Curr to conc for soma
                Ca_base 0.0
        addfield Ca_s11 addmsg1
        setfield Ca_s11 \
                addmsg1        "../CaH11 . I_Ca Ik"
        addfield Ca_s11 addmsg2
        setfield Ca_s11 \
                addmsg2        "../CaL11 . I_Ca Ik"
end
/*
...
/****************************************************************************/
function make_Ca_d11
        if ({exists Ca_d11})
                return
        end
        create Ca_concen Ca_d11
        setfield Ca_d11 \
                tau     0.010   \      // sec (nl .010)
                B       17.402e12 \      // Curr to conc for soma
                Ca_base 0.0
        addfield Ca_d11 addmsg1
        setfield Ca_d11 \
                addmsg1        "../CaH11 . I_Ca Ik"
        addfield Ca_d11 addmsg2
        setfield Ca_d11 \
                addmsg2        "../CaL11 . I_Ca Ik"
end
/*
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCs11 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCs11 X_A->table[{i}] {alpha}
            setfield KCs11 X_B->table[{i}] {alpha+beta}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCs11 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs11 Xpower 1
    call KCs11 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs11 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCs11 Z_A->table[{i}] {y}
            setfield KCs11 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCs11 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs11 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs11 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs11 TABFILL Z 3000 0
...
// reader.
        addfield KCs11 addmsg1
        setfield KCs11 addmsg1  "../Ca_s11  . CONCEN Ca"
end
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCd11 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KCd11 X_A->table[{i}] {alpha}
            setfield KCd11 X_B->table[{i}] {alpha+beta}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCd11 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd11 Xpower 1
    call KCd11 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd11 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd11 Z_A->table[{i}] {y}
            setfield KCd11 Z_B->table[{i}] 1.0
            x = x + dx
        end
        setfield KCd11 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd11 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd11 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd11 TABFILL Z 3000 0

// Now we need to provide for messages that link to external elements.
// The message that sends the Ca concentration to the Z gate tables is stored
// in an added field of the channel, so that it may be found by the cell
// reader.
        addfield KCd11 addmsg1
        setfield KCd11 addmsg1  "../Ca_d11  . CONCEN Ca"
end
...
function make_KAHPs11
        if ({exists KAHPs11})
                return
        end

        create  tabchannel      KAHPs11
                setfield        ^       \
                Ek              {EKP6RSa}   \               //      V
                Gbar            { 8 * SOMA_A }    \    //      S
                Ik              0       \              //      A
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs11 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs11 Z_A->table[{i}] {y}
            setfield KAHPs11 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs11 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs11 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element
        addfield KAHPs11 addmsg1
        setfield KAHPs11  \
                addmsg1        "../Ca_s11 . CONCEN Ca"
end


function make_KAHPd11
        if ({exists KAHPd11})
                return
        end

        create  tabchannel      KAHPd11
                setfield        ^       \
                Ek              {EKP6RSa}   \               //      V
                Gbar            { 8 * SOMA_A }    \    //      S
                Ik              0       \              //      A
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd11 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd11 Z_A->table[{i}] {y}
            setfield KAHPd11 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd11 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd11 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element
        addfield KAHPd11 addmsg1
        setfield KAHPd11  \
                addmsg1        "../Ca_d11 . CONCEN Ca"
end

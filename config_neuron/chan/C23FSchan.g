...
float ENAC23FS = 0.110 + EREST_ACT // 0.050
float EKC23FS = -0.040 + EREST_ACT // -0.100
float ECAC23FS = 0.185 + EREST_ACT // 0.125
float EARC23FS = 0.025 + EREST_ACT // -0.035
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaF15  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF15  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF15  X_A->table[{i}] {y}
            setfield NaF15  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF15  Y_A->table[{i}] {y}
            setfield NaF15  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF15  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF15  TABFILL X 3000 0

        setfield NaF15  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF15  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaP15 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP15 X_A->table[{i}] {y}
            setfield NaP15 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP15  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP15  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call AR15 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR15 X_A->table[{i}] {y}
            setfield AR15 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR15 X_A->calc_mode 0   X_B->calc_mode 0
        call AR15 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KDR15 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR15 X_A->table[{i}] {y}
            setfield KDR15 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR15 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR15 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KA15 TABCREATE X {xdivs} {xmin} {xmax}
    call KA15 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA15 X_A->table[{i}] {y}
            setfield KA15 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA15 Y_A->table[{i}] {y}
            setfield KA15 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA15 X_A->calc_mode 0   X_B->calc_mode 0
        call KA15 TABFILL X 3000 0

        setfield KA15 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA15 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call K215 TABCREATE X {xdivs} {xmin} {xmax}
    call K215 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K215 X_A->table[{i}] {y}
            setfield K215 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K215 Y_A->table[{i}] {y}
            setfield K215 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K215 X_A->calc_mode 0   X_B->calc_mode 0
        call K215 TABFILL X 3000 0

        setfield K215 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K215 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KM15 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM15 X_A->table[{i}] {y}
            setfield KM15 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM15 X_A->calc_mode 0   X_B->calc_mode 0
        call KM15 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaL15 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL15 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL15 X_A->table[{i}] {y}
            setfield CaL15 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL15 Y_A->table[{i}] {y}
            setfield CaL15 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL15 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL15 TABFILL X 3000 0

        setfield CaL15 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL15 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaH15 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH15 X_A->table[{i}] {y}
            setfield CaH15 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH15 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH15 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCs15 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCs15 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCs15 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs15 Xpower 1
    call KCs15 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs15 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
           ...
           setfield KCs15 Z_A->table[{i}] {y}
           setfield KCs15 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCs15 Z_A->table[{i}] {y/2}
            //setfield KCs15 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCs15 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs15 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs15 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs15 TABFILL Z 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCd15 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCd15 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCd15 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd15 Xpower 1
    call KCd15 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd15 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd15 Z_A->table[{i}] {y}
            setfield KCd15 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCd15 Z_A->table[{i}] {y/2}
            //setfield KCd15 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCd15 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd15 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd15 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd15 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs15 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs15 Z_A->table[{i}] {y}
            setfield KAHPs15 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs15 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs15 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd15 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd15 Z_A->table[{i}] {y}
            setfield KAHPd15 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd15 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd15 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

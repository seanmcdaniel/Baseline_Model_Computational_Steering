...
float ENATCR = 0.110 + EREST_ACT // 0.050
float EKTCR = -0.040 + EREST_ACT // -0.100
float ECATCR = 0.185 + EREST_ACT // 0.125
float EARTCR = 0.025 + EREST_ACT // -0.035
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaF20  TABCREATE X {xdivs} {xmin} {xmax}
    call NaF20  TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF20  X_A->table[{i}] {y}
            setfield NaF20  X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaF20  Y_A->table[{i}] {y}
            setfield NaF20  Y_B->table[{i}] {z}
            x = x + dx
        end
...
// and use TABFILL to expand the table to 3000 entries.
        setfield NaF20  X_A->calc_mode 0   X_B->calc_mode 0
        call NaF20  TABFILL X 3000 0

        setfield NaF20  Y_A->calc_mode 0   Y_B->calc_mode 0
        call NaF20  TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call NaP20 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield NaP20 X_A->table[{i}] {y}
            setfield NaP20 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield NaP20  X_A->calc_mode 0   X_B->calc_mode 0
        call NaP20  TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call AR20 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield AR20 X_A->table[{i}] {y}
            setfield AR20 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield AR20 X_A->calc_mode 0   X_B->calc_mode 0
        call AR20 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KDR20 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KDR20 X_A->table[{i}] {y}
            setfield KDR20 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KDR20 X_A->calc_mode 0   X_B->calc_mode 0
        call KDR20 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KA20 TABCREATE X {xdivs} {xmin} {xmax}
    call KA20 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA20 X_A->table[{i}] {y}
            setfield KA20 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KA20 Y_A->table[{i}] {y}
            setfield KA20 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KA20 X_A->calc_mode 0   X_B->calc_mode 0
        call KA20 TABFILL X 3000 0

        setfield KA20 Y_A->calc_mode 0   Y_B->calc_mode 0
        call KA20 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call K220 TABCREATE X {xdivs} {xmin} {xmax}
    call K220 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K220 X_A->table[{i}] {y}
            setfield K220 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield K220 Y_A->table[{i}] {y}
            setfield K220 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield K220 X_A->calc_mode 0   X_B->calc_mode 0
        call K220 TABFILL X 3000 0

        setfield K220 Y_A->calc_mode 0   Y_B->calc_mode 0
        call K220 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call KM20 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KM20 X_A->table[{i}] {y}
            setfield KM20 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KM20 X_A->calc_mode 0   X_B->calc_mode 0
        call KM20 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaL20 TABCREATE X {xdivs} {xmin} {xmax}
    call CaL20 TABCREATE Y {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL20 X_A->table[{i}] {y}
            setfield CaL20 X_B->table[{i}] {z}
            x = x + dx
        end
...
// Fill the Y_A table with alpha values and the Y_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaL20 Y_A->table[{i}] {y}
            setfield CaL20 Y_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaL20 X_A->calc_mode 0   X_B->calc_mode 0
        call CaL20 TABFILL X 3000 0

        setfield CaL20 Y_A->calc_mode 0   Y_B->calc_mode 0
        call CaL20 TABFILL Y 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
    ...
    call CaH20 TABCREATE X {xdivs} {xmin} {xmax}
...
// Fill the X_A table with alpha values and the X_B table with (alpha+beta)
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield CaH20 X_A->table[{i}] {y}
            setfield CaH20 X_B->table[{i}] {z}
            x = x + dx
        end

// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield CaH20 X_A->calc_mode 0   X_B->calc_mode 0
        call CaH20 TABFILL X 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCs20 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        ...
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCs20 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCs20 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCs20 Xpower 1
    call KCs20 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCs20 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
           ...
           setfield KCs20 Z_A->table[{i}] {y}
           setfield KCs20 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCs20 Z_A->table[{i}] {y/2}
            //setfield KCs20 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCs20 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCs20 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCs20 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCs20 TABFILL Z 3000 0
...
// covering the range xmin = -0.1 to xmax = 0.05.
        ...
        call KCd20 TABCREATE X {xdivs} {xmin} {xmax}
        int i
        float x,dx,alpha,beta
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            //setfield KCd20 X_B->table[{i}] {2*{alpha+beta}}
            x = x + dx
        end

// Expand the tables to 3000 entries to use without interpolation
    setfield KCd20 X_A->calc_mode 0 X_B->calc_mode 0
    setfield KCd20 Xpower 1
    call KCd20 TABFILL X 3000 0
...
//  rather than being used in a differential equation.
        ...
        call KCd20 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            /* activation will be computed as Z_A/Z_B */
            setfield KCd20 Z_A->table[{i}] {y}
            setfield KCd20 Z_B->table[{i}] 1.0

           /* activation will be computed as Z_A/Z_B */
            //setfield KCd20 Z_A->table[{i}] {y/2}
            //setfield KCd20 Z_B->table[{i}] 0.5

            x = x + dx
        end
        setfield KCd20 Z_A->calc_mode 0 Z_B->calc_mode 0
        setfield KCd20 Zpower 1
// Make it an instantaneous gate (no time constant)
    setfield KCd20 instant {INSTANTZ}
// Expand the table to 3000 entries to use without interpolation.
    call KCd20 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPs20 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPs20 Z_A->table[{i}] {y}
            setfield KAHPs20 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPs20 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPs20 TABFILL Z 3000 0
...
// range from xmin = 0 to xmax = 1000, with 50 divisions
        ...
        call KAHPd20 TABCREATE Z {xdivs} {xmin} {xmax}
        int i
        float x,dx,y
        dx = (xmax - xmin)/xdivs
        x = xmin
        for (i = 0 ; i <= {xdivs} ; i = i + 1)
            ...
            setfield KAHPd20 Z_A->table[{i}] {y}
            setfield KAHPd20 Z_B->table[{i}] {y + 10.0}
            x = x + dx
        end
// For speed during execution, set the calculation mode to "no interpolation"
// and use TABFILL to expand the table to 3000 entries.
        setfield KAHPd20 Z_A->calc_mode 0   Z_B->calc_mode 0
        call KAHPd20 TABFILL Z 3000 0
// Use an added field to tell the cell reader to set up the
// CONCEN message from the Ca_concen element

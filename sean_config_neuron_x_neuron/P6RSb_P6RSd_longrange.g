...
//float destlim = {P6RSb_P6RSd_destlim}
...
echo Making connections from the P6RSb cells to the P6RSd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSb_P6RSd_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSb->P6RSd connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12longrange -radial {{P6RSb_P6RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSb_P6RSd longrangeweight is {longrangeweight}
barrierall //ayu

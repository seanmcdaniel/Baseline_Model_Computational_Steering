...
float destlim = {P23RSb_C23FS_destlim}
...
echo Making connections from the P23RSb cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSb_C23FS_prob}}
...
echo Setting weights and delays for P23RSb->C23FS connections.
...
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSAMPA {P23RSb_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSNMDA {P23RSb_C23FS_syndelay} -add

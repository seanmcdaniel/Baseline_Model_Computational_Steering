...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSd_P23RSa_prob}}
          //-probability 0.5
...
//    barrierall //ayu
//    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4longrange  \
//	      /P23RSanet/P23RSa[]/{s}/Inh_ch1P23RSGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
// assigning delays
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4longrange -radial {{P23RSd_P23RSa_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSd_P23RSa longrangeweight is {longrangeweight}
barrierall //ayu

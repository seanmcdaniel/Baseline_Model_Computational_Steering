...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBd_P5IBb_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9longrange -radial {{P5IBd_P5IBb_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBd_P5IBb longrangeweight is {longrangeweight}
barrierall //ayu

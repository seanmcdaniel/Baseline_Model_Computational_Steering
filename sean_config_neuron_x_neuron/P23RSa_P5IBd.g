...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSa_P5IBd_prob}}
...
barrierall //ayu
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_P5IBd_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P23RSAMPA {P23RSa_P5IBd_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P23RSNMDA {P23RSa_P5IBd_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSd_P6RSb_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P6RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSd_P6RSb longrangeweight is {longrangeweight}
barrierall //ayu

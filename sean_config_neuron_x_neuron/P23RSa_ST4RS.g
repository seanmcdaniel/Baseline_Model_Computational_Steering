...
float destlim = {P23RSa_ST4RS_destlim}
...
echo Making connections from the P23RSa cells to the ST4RS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability {{shortrangeprobscale}*{P23RSa_ST4RS_prob}}
...
echo Setting weights and delays for P23RSa->ST4RS connections.
...
barrierall //ayu
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_ST4RS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSAMPA {P23RSa_ST4RS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSNMDA {P23RSa_ST4RS_syndelay} -add

...
echo Making connections from the P23FRBa cells to the P5IBc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22  \
          ...
          -probability {{shortrangeP23probscale}*{P23FRBa_P5IBc_prob}}
...
echo Setting weights and delays for P23FRBa->P5IBc connections.
...
barrierall //ayu
rvolumedelay /P23FRBanet/P23FRBa[]/soma/spk22 -radial  {P23FRBa_P5IBc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P23RSAMPA {P23FRBa_P5IBc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P23RSNMDA {P23FRBa_P5IBc_syndelay} -add

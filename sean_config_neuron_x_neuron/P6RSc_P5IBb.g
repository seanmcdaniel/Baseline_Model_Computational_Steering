...
float destlim = {P6RSc_P5IBb_destlim}
...
echo Making connections from the P6RSc cells to the P5IBb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability {{shortrangeprobscale}*{P6RSc_P5IBb_prob}}
...
echo Setting weights and delays for P6RSc->P5IBb connections.
...
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_P5IBb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P6RSAMPA {P6RSc_P5IBb_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P6RSNMDA {P6RSc_P5IBb_syndelay} -add

...
//float destlim = {P5IBd_P6RSc_destlim}
...
echo Making connections from the P5IBd cells to the P6RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
	      /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBAMPA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{longrangeprobscale}*{P5IBd_P6RSc_prob}}
          //-probability 0.5
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
	      /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBNMDA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1    \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
//    barrierall //ayu
//    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
//	      /P6RScnet/P6RSc[]/{s}/Inh_ch13P5IBGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P5IBd->P6RSc connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9longrange -radial {{P5IBd_P6RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBd_P6RSc longrangeweight is {longrangeweight}
barrierall //ayu

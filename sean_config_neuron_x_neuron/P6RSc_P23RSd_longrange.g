...
//float destlim = {P6RSc_P23RSd_destlim}
...
echo Making connections from the P6RSc cells to the P23RSd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
	      /P23RSdnet/P23RSd[]/{s}/Ex_ch4P6RSAMPA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{longrangeprobscale}*{P6RSc_P23RSd_prob}}
          //-probability 0.5
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
	      /P23RSdnet/P23RSd[]/{s}/Ex_ch4P6RSNMDA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1    \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
//    barrierall //ayu
//    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
//	      /P23RSdnet/P23RSd[]/{s}/Inh_ch4P6RSGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P6RSc->P23RSd connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13longrange -radial {{P6RSc_P23RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSc_P23RSd longrangeweight is {longrangeweight}
barrierall //ayu

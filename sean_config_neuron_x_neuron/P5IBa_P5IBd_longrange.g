...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBa_P5IBd_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6longrange -radial {{P5IBa_P5IBd_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBa_P5IBd longrangeweight is {longrangeweight}
barrierall //ayu

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_I23LTS_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_I23LTS_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_I23LTS longrangeweight is {longrangeweight}
barrierall //ayu

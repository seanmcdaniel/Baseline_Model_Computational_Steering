...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability {{shortrangeprobscale}*{P5IBd_C5FS_prob}}
...
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_C5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBAMPA {P5IBd_C5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBNMDA {P5IBd_C5FS_syndelay} -add

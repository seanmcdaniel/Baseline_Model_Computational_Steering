...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBa_P6RSd_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6longrange -radial {{P5IBa_P6RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBa_P6RSd longrangeweight is {longrangeweight}
barrierall //ayu

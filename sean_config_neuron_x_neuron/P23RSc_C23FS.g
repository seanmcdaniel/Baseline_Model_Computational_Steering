...
float destlim = {P23RSc_C23FS_destlim}
...
echo Making connections from the P23RSc cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSc_C23FS_prob}}
...
echo Setting weights and delays for P23RSc->C23FS connections.
...
barrierall //ayu
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3 -radial  {P23RSc_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSAMPA {P23RSc_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSNMDA {P23RSc_C23FS_syndelay} -add

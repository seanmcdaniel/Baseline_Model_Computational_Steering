...
//float destlim = {P6RSa_C5FS_destlim}
...
echo Making connections from the P6RSa cells to the C5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_C5FS_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSa->C5FS connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_C5FS_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_C5FS longrangeweight is {longrangeweight}
barrierall //ayu

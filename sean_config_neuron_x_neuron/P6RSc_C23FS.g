...
float destlim = {P6RSc_C23FS_destlim}
...
echo Making connections from the P6RSc cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability {{shortrangeprobscale}*{P6RSc_C23FS_prob}}
...
echo Setting weights and delays for P6RSc->C23FS connections.
...
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSAMPA {P6RSc_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSNMDA {P6RSc_C23FS_syndelay} -add

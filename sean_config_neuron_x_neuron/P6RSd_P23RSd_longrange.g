...
//float destlim = {P6RSd_P23RSd_destlim}
...
echo Making connections from the P6RSd cells to the P23RSd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSd_P23RSd_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSd->P23RSd connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P23RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSd_P23RSd longrangeweight is {longrangeweight}
barrierall //ayu

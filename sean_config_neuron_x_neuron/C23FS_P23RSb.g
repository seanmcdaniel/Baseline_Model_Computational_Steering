...
rvolumeconnect /C23FSnet/C23FS[]/soma/spk15  \
	      /P23RSbnet/P23RSb[]/axona/Inh_ch2C23FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{C23FS_P23RSb_prob}}
...
barrierall //ayu
rvolumedelay /C23FSnet/C23FS[]/soma/spk15 -radial  {C23FS_P23RSb_axdelayCV} -add

//C23FS - P23RSb GABAa

barrierall //ayu
syndelay    /P23RSbnet/P23RSb[]/axona/Inh_ch2C23FSGABAa {C23FS_P23RSb_syndelay} -add

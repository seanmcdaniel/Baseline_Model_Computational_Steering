...
float destlim = {P6RSd_ST4RS_destlim}
...
echo Making connections from the P6RSd cells to the ST4RS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability {{shortrangeprobscale}*{P6RSd_ST4RS_prob}}
...
echo Setting weights and delays for P6RSd->ST4RS connections.
...
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_ST4RS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSAMPA {P6RSd_ST4RS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSNMDA {P6RSd_ST4RS_syndelay} -add

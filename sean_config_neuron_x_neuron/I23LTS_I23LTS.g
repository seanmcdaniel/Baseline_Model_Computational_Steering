...
float destlim = {I23LTS_I23LTS_destlim}
...
echo Making connections from the I23LTS cells to the I23LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I23LTSnet/I23LTS[]/soma/spk18  \
	      /I23LTSnet/I23LTS[]/{s}/Inh_ch18I23LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I23LTS_I23LTS_prob}}

end

echo Setting weights and delays for I23LTS->I23LTS connections.
...
barrierall //ayu
rvolumedelay /I23LTSnet/I23LTS[]/soma/spk18 -radial  {I23LTS_I23LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Inh_ch18I23LTSGABAa {I23LTS_I23LTS_syndelay} -add

...
float destlim = {P23RSc_P23RSb_destlim}
...
echo Making connections from the P23RSc cells to the P23RSb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSc_P23RSb_prob}}
...
echo Setting weights and delays for P23RSc->P23RSb connections.
...
barrierall //ayu
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3 -radial  {P23RSc_P23RSb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P23RSAMPA {P23RSc_P23RSb_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P23RSNMDA {P23RSc_P23RSb_syndelay} -add

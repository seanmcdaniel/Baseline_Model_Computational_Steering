...
rvolumeconnect /C23FSnet/C23FS[]/soma/spk15  \
	      /P23FRBanet/P23FRBa[]/axona/Inh_ch22C23FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{C23FS_P23FRBa_prob}}
...
barrierall //ayu
rvolumedelay /C23FSnet/C23FS[]/soma/spk15 -radial  {C23FS_P23FRBa_axdelayCV} -add

//C23FS - P23FRBa GABAa

barrierall //ayu
syndelay    /P23FRBanet/P23FRBa[]/axona/Inh_ch22C23FSGABAa {C23FS_P23FRBa_syndelay} -add

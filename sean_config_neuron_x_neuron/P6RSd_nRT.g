...
float destlim = {P6RSd_nRT_destlim}
...
echo Making connections from the P6RSd cells to the nRT cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability {{shortrangeprobscale}*{P6RSd_nRT_prob}}
...
echo Setting weights and delays for P6RSd->nRT connections.
...
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_nRT_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /nRTnet/nRT[]/{s}/Ex_ch21P6RSAMPA {P6RSd_nRT_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /nRTnet/nRT[]/{s}/Ex_ch21P6RSNMDA {P6RSd_nRT_syndelay} -add

...
echo Making connections from the P5IBa cells to the P23FRBa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBa_P23FRBa_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBa->P23FRBa connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6longrange -radial {{P5IBa_P23FRBa_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBa_P23FRBa longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P5IBc_P5IBd_destlim}
...
echo Making connections from the P5IBc cells to the P5IBd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability {{shortrangeprobscale}*{P5IBc_P5IBd_prob}}
...
echo Setting weights and delays for P5IBc->P5IBd connections.
...
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5IBd_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBAMPA {P5IBc_P5IBd_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBNMDA {P5IBc_P5IBd_syndelay} -add

...
float destlim = {I5LTS_P5IBb_destlim}
...
echo Making connections from the I5LTS cells to the P5IBb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /P5IBbnet/P5IBb[]/{s}/Inh_ch7I5LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I5LTS_P5IBb_prob}}

end

echo Setting weights and delays for I5LTS->P5IBb connections.

...
//float destlim = {P6RSb_P5RSa_destlim}
...
echo Making connections from the P6RSb cells to the P5RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
	      /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSAMPA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{longrangeprobscale}*{P6RSb_P5RSa_prob}}
          //-probability 0.5
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
	      /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSNMDA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1    \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
//    barrierall //ayu
//    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
//	      /P5RSanet/P5RSa[]/{s}/Inh_ch23P6RSGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P6RSb->P5RSa connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12longrange -radial {{P6RSb_P5RSa_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSb_P5RSa longrangeweight is {longrangeweight}
barrierall //ayu

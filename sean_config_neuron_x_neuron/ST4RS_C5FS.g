...
float destlim = {ST4RS_C5FS_destlim}
...
echo Making connections from the ST4RS cells to the C5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /ST4RSnet/ST4RS[]/soma/spk17  \
          ...
          -probability {{shortrangeprobscale}*{ST4RS_C5FS_prob}}
...
echo Setting weights and delays for ST4RS->C5FS connections.
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16ST4RSAMPA {ST4RS_C5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16ST4RSNMDA {ST4RS_C5FS_syndelay} -add

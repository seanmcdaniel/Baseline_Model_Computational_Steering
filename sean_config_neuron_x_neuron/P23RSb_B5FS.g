...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSb_B5FS_prob}}
...
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_B5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSAMPA {P23RSb_B5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSNMDA {P23RSb_B5FS_syndelay} -add

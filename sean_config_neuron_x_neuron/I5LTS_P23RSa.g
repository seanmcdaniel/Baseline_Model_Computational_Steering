...
float destlim = {I5LTS_P23RSa_destlim}
...
echo Making connections from the I5LTS cells to the P23RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
          ...
          -probability {{shortrangeprobscale}*{I5LTS_P23RSa_prob}}

end

echo Setting weights and delays for I5LTS->P23RSa connections.
...
volumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_P23RSa_axdelayCV} -add -gaussian {I5LTS_P23RSa_axdelaystdev} {I5LTS_P23RSa_axdelaymaxdev}

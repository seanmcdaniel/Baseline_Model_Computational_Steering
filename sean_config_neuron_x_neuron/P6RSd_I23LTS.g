...
echo Making connections from the P6RSd cells to the I23LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability {{shortrangeprobscale}*{P6RSd_I23LTS_prob}}
...
echo Setting weights and delays for P6RSd->I23LTS connections.
...
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_I23LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P6RSAMPA {P6RSd_I23LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P6RSNMDA {P6RSd_I23LTS_syndelay} -add

...
float destlim = {I23LTS_P23FRBa_destlim}
...
echo Making connections from the I23LTS cells to the P23FRBa cells.


//I23LTS - P23FRBa GABAa
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I23LTSnet/I23LTS[]/soma/spk18  \
	      /P23FRBanet/P23FRBa[]/{s}/Inh_ch22I23LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I23LTS_P23FRBa_prob}}

end

echo Setting weights and delays for I23LTS->P23FRBa connections.
...
barrierall //ayu
rvolumedelay /I23LTSnet/I23LTS[]/soma/spk18 -radial  {I23LTS_P23FRBa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Inh_ch22I23LTSGABAa {I23LTS_P23FRBa_syndelay} -add

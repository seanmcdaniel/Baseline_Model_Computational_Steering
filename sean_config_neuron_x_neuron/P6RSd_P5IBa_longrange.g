...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSd_P5IBa_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P5IBa_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSd_P5IBa longrangeweight is {longrangeweight}
barrierall //ayu

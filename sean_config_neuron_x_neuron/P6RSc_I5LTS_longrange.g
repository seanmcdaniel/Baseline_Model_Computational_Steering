...
//float destlim = {P6RSc_I5LTS_destlim}
...
echo Making connections from the P6RSc cells to the I5LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSc_I5LTS_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSc->I5LTS connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13longrange -radial {{P6RSc_I5LTS_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSc_I5LTS longrangeweight is {longrangeweight}
barrierall //ayu

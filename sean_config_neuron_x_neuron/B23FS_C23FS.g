...
float destlim = {B23FS_C23FS_destlim}
...
echo Making connections from the B23FS cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /B23FSnet/B23FS[]/soma/spk5  \
	      /C23FSnet/C23FS[]/{s}/Inh_ch15B23FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{B23FS_C23FS_prob}}

end

echo Setting weights and delays for B23FS->C23FS connections.
...
barrierall //ayu
rvolumedelay /B23FSnet/B23FS[]/soma/spk5 -radial  {B23FS_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Inh_ch15B23FSGABAa {B23FS_C23FS_syndelay} -add

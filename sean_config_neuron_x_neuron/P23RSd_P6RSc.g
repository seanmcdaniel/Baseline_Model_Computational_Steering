...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSd_P6RSc_prob}}
...
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_P6RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P23RSAMPA {P23RSd_P6RSc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P23RSNMDA {P23RSd_P6RSc_syndelay} -add

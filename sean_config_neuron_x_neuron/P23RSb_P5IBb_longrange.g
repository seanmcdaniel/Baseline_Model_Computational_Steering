...
echo Making connections from the P23RSb cells to the P5IBb cells.
...
echo Setting weights and delays for P23RSb->P5IBb connections.
...
echo P23RSb_P5IBb longrangeweight is {longrangeweight}
barrierall //ayu

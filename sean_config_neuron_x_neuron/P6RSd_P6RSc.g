...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability {{shortrangeprobscale}*{P6RSd_P6RSc_prob}}
...
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_P6RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P6RSAMPA {P6RSd_P6RSc_syndelay} -add

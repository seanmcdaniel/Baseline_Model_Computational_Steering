...
float destlim = {P6RSb_TCR_destlim}
...
echo Making connections from the P6RSb cells to the TCR cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_TCR_prob}}
...
echo Setting weights and delays for P6RSb->TCR connections.
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -fixed  {P6RSb_TCR_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSAMPA {P6RSb_TCR_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSNMDA {P6RSb_TCR_syndelay} -add

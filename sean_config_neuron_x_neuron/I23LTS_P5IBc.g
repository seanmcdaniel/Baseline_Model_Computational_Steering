...
float destlim = {I23LTS_P5IBc_destlim}
...
echo Making connections from the I23LTS cells to the P5IBc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I23LTSnet/I23LTS[]/soma/spk18  \
	      /P5IBcnet/P5IBc[]/{s}/Inh_ch8I23LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I23LTS_P5IBc_prob}}

end

echo Setting weights and delays for I23LTS->P5IBc connections.
...
barrierall //ayu
rvolumedelay /I23LTSnet/I23LTS[]/soma/spk18 -radial  {I23LTS_P5IBc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Inh_ch8I23LTSGABAa {I23LTS_P5IBc_syndelay} -add

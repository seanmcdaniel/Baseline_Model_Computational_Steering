...
//float destlim = {P5IBb_P6RSa_destlim}
...
echo Making connections from the P5IBb cells to the P6RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBb_P6RSa_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBb->P6RSa connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7longrange -radial {{P5IBb_P6RSa_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBb_P6RSa longrangeweight is {longrangeweight}
barrierall //ayu

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability {{shortrangeprobscale}*{P5IBd_P6RSc_prob}}
...
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P6RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBAMPA {P5IBd_P6RSc_syndelay} -add

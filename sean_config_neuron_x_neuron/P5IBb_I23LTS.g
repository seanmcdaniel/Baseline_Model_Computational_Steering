...
float destlim = {P5IBb_I23LTS_destlim}
...
echo Making connections from the P5IBb cells to the I23LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability {{shortrangeprobscale}*{P5IBb_I23LTS_prob}}
...
echo Setting weights and delays for P5IBb->I23LTS connections.
...
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_I23LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P5IBAMPA {P5IBb_I23LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P5IBNMDA {P5IBb_I23LTS_syndelay} -add

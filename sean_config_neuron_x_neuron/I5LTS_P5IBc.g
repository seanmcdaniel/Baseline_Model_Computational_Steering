...
float destlim = {I5LTS_P5IBc_destlim}
...
echo Making connections from the I5LTS cells to the P5IBc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /P5IBcnet/P5IBc[]/{s}/Inh_ch8I5LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I5LTS_P5IBc_prob}}

end

echo Setting weights and delays for I5LTS->P5IBc connections.
...
barrierall //ayu
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_P5IBc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Inh_ch8I5LTSGABAa {I5LTS_P5IBc_syndelay} -add

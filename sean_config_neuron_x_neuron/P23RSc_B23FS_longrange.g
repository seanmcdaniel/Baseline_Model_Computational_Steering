...
//float destlim = {P23RSc_B23FS_destlim}
...
echo Making connections from the P23RSc cells to the B23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSc_B23FS_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P23RSc->B23FS connections.

// assigning delays
barrierall //ayu
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3longrange -radial {{P23RSc_B23FS_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSc_B23FS longrangeweight is {longrangeweight}
barrierall //ayu

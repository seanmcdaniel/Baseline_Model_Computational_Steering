...
float destlim = {P6RSa_C23FS_destlim}
...
echo Making connections from the P6RSa cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
          ...
          -probability {{shortrangeprobscale}*{P6RSa_C23FS_prob}}
...
echo Setting weights and delays for P6RSa->C23FS connections.
...
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSAMPA {P6RSa_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSNMDA {P6RSa_C23FS_syndelay} -add

...
float destlim = {P6RSb_P6RSa_destlim}
...
echo Making connections from the P6RSb cells to the P6RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_P6RSa_prob}}
...
echo Setting weights and delays for P6RSb->P6RSa connections.
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P6RSa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSAMPA {P6RSb_P6RSa_syndelay} -add

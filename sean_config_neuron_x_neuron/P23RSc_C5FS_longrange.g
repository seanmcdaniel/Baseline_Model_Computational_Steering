...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSc_C5FS_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3longrange -radial {{P23RSc_C5FS_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSc_C5FS longrangeweight is {longrangeweight}
barrierall //ayu

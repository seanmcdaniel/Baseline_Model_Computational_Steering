...
float destlim = {P6RSb_P5IBb_destlim}
...
echo Making connections from the P6RSb cells to the P5IBb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_P5IBb_prob}}
...
echo Setting weights and delays for P6RSb->P5IBb connections.
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P5IBb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P6RSAMPA {P6RSb_P5IBb_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P6RSNMDA {P6RSb_P5IBb_syndelay} -add

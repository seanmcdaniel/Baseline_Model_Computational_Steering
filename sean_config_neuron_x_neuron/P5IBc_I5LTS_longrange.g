...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBc_I5LTS_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8longrange -radial {{P5IBc_I5LTS_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBc_I5LTS longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P23RSd_P23RSc_destlim}
...
echo Making connections from the P23RSd cells to the P23RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSd_P23RSc_prob}}
...
echo Setting weights and delays for P23RSd->P23RSc connections.
...
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_P23RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P23RSAMPA {P23RSd_P23RSc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P23RSNMDA {P23RSd_P23RSc_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability {{shortrangeprobscale}*{P6RSc_I5LTS_prob}}
...
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_I5LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSAMPA {P6RSc_I5LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSNMDA {P6RSc_I5LTS_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_P5IBc_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_P5IBc_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_P5IBc longrangeweight is {longrangeweight}
barrierall //ayu

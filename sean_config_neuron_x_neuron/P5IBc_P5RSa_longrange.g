...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBc_P5RSa_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8longrange -radial {{P5IBc_P5RSa_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBc_P5RSa longrangeweight is {longrangeweight}
barrierall //ayu

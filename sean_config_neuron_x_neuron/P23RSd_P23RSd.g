...
float destlim = {P23RSd_P23RSd_destlim}
...
echo Making connections from the P23RSd cells to the P23RSd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSd_P23RSd_prob}}
...
echo Setting weights and delays for P23RSd->P23RSd connections.
...
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_P23RSd_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P23RSAMPA {P23RSd_P23RSd_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P23RSNMDA {P23RSd_P23RSd_syndelay} -add

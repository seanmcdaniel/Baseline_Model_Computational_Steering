...
float destlim = {P5IBb_B23FS_destlim}
...
echo Making connections from the P5IBb cells to the B23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
	      /B23FSnet/B23FS[]/{s}/Ex_ch5P5IBAMPA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{P5IBb_B23FS_prob}}
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
	      /B23FSnet/B23FS[]/{s}/Ex_ch5P5IBNMDA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P5IBb->B23FS connections.
...
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_B23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P5IBAMPA {P5IBb_B23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P5IBNMDA {P5IBb_B23FS_syndelay} -add

...
float destlim = {P5IBc_I5LTS_destlim}
...
echo Making connections from the P5IBc cells to the I5LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability {{shortrangeprobscale}*{P5IBc_I5LTS_prob}}
...
echo Setting weights and delays for P5IBc->I5LTS connections.
...
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_I5LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P5IBAMPA {P5IBc_I5LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P5IBNMDA {P5IBc_I5LTS_syndelay} -add

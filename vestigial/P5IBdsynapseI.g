...
// Specifically for P5IBd synaptic currents

echo P5IBd Synaptic Currents - LFP Setup !!!!!!!!!!!!!!!!!!!!!
echo
...
kmax = P5IBd_NX*P5IBd_NY-1

//Load synapse location array, P23RS - P5IBd AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP23RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P23RSAMPA LFPsynmodcent CURRENT Ik 0.0
...
//Load synapse location array, P23RS - P5IBd NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP23RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P23RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P5IB - P5IBd AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP5IB}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P5IBAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P5IB - P5IBd NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP5IB}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P5IBNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, B5FS - P5IBd GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsB5FS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Inh_ch9B5FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P6RS - P5IBd AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP6RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P6RSAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P6RS - P5IBd NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP6RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9P6RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, C23FS - P5IBd GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsC23FS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Inh_ch9C23FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, C5FS - P5IBd GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsC5FS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Inh_ch9C5FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, ST4RS - P5IBd AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsST4RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9ST4RSAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, ST4RS - P5IBd NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsST4RS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9ST4RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, I23LTS - P5IBd GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsI23LTS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Inh_ch9I23LTSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, I5LTS - P5IBd GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsI5LTS}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Inh_ch9I5LTSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, TCR - P5IBd AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsTCR}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9TCRAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, TCR - P5IBd NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsTCR}})
          ...
          addmsg /P5IBdnet/P5IBd[{k}]/{s}/Ex_ch9TCRNMDA LFPsynmodcent CURRENT Ik 0.0

...
echo P5IBd - P5IBd Gap Junctions
...
for (i=0;i<=(P5IBd_NY-1);i=i+1)
    for (j=0;j<=(P5IBd_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBd_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P5IBd_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
        ...
        if ({dexS==P5IBd_NY} && {randconn<{globalconnprob}} && {dexE==P5IBd_NX} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        ...
        if ({dexS==P5IBd_NY} && {randconn<{globalconnprob}} && {dexE==1} && { {jnodedex} > 0 }) //for nodal edge corner

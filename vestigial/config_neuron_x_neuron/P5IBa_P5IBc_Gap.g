...
echo P5IBa - P5IBc Gap Junctions
...
for (i=0;i<=(P5IBa_NY-1);i=i+1)
    for (j=0;j<=(P5IBc_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P5IBanet/P5IBa[{conn1dex}]/{conn1loc} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc} /P5IBanet/P5IBa[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P5IBanet/P5IBa[{conn1dex}]/{conn1loc} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc} /P5IBanet/P5IBa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBa_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P5IBanet/P5IBa[{conn1dex}]/{conn1loc} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc} /P5IBanet/P5IBa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P5IBa_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P5IBanet/P5IBa[{conn1dex}]/{conn1loc} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P5IBcnet/P5IBc[{conn2dex}]/{conn2loc} /P5IBanet/P5IBa[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

...
echo I23LTS - I23LTS TraubGap!!! Junctions

for (i=0;i<=(I23LTS_NY-1);i=i+1)
    for (j=0;j<=(I23LTS_NX/2-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(i-1)*I23LTS_NX/2+j
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(I23LTS_NY-1)*I23LTS_NX/2+j
        ...
        if ({dexN>=0} && {dexE<I23LTS_NX/2} && {randconn<{globalconnprob}})
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(i-1)*I23LTS_NX/2+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE<I23LTS_NX/2} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(I23LTS_NY-1)*I23LTS_NX/2+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==I23LTS_NX/2} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner

            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(I23LTS_NY-1)*I23LTS_NX/2
        ...
        if ( {dexE==I23LTS_NX/2} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge

            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(i-1)*I23LTS_NX/2
        ...
        if ({dexE<I23LTS_NX/2} && {randconn<{globalconnprob}})
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(i)*I23LTS_NX/2+j+1
        ...
        if ({dexE==I23LTS_NX/2} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge

            conn1dex=i*I23LTS_NX/2+j
            conn2dex=i*I23LTS_NX/2
        ...
        if ({dexE<I23LTS_NX/2} && {dexS>I23LTS_NY} && {randconn<{globalconnprob}})
        ...
        if ({dexE==I23LTS_NX/2} && {randconn<{globalconnprob}} && {dexS<I23LTS_NY} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS==I23LTS_NY} && {randconn<{globalconnprob}} && {dexE==I23LTS_NX/2} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        ...
        if ( {dexE<I23LTS_NX/2} && {dexS==I23LTS_NY} && {randconn<{globalconnprob}} &&{ {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}} } ) //for nodal edge
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==1} && { {mynode} >= {sqrtNnodes} } && { {jnodedex} > 0 }) //for nodal edge corner
            ...
            conn1dex=i*I23LTS_NX/2+j
            conn2dex=(I23LTS_NY*I23LTS_NX/2)-1

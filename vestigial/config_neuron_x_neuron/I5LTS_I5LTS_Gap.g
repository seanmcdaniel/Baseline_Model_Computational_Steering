...
echo I5LTS - I5LTS Gap Junctions

for (i=0;i<=(I5LTS_NY-1);i=i+1)
    for (j=0;j<=(I5LTS_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            conn1dex=i*I5LTS_NX+j
            conn2dex=(i-1)*I5LTS_NX+j
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*I5LTS_NX+j
            conn2dex=(I5LTS_NY-1)*I5LTS_NX+j
        ...
        if ({dexN>=0} && {dexE<I5LTS_NX} && {randconn<{globalconnprob}})
            conn1dex=i*I5LTS_NX+j
            conn2dex=(i-1)*I5LTS_NX+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE<I5LTS_NX} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*I5LTS_NX+j
            conn2dex=(I5LTS_NY-1)*I5LTS_NX+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==I5LTS_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner

            conn1dex=i*I5LTS_NX+j
            conn2dex=(I5LTS_NY-1)*I5LTS_NX
        ...
        if ( {dexE==I5LTS_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge

            conn1dex=i*I5LTS_NX+j
            conn2dex=(i-1)*I5LTS_NX
        ...
        if ({dexE<I5LTS_NX} && {randconn<{globalconnprob}})
            conn1dex=i*I5LTS_NX+j
            conn2dex=(i)*I5LTS_NX+j+1
        ...
        if ({dexE==I5LTS_NX} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexE<I5LTS_NX} && {dexS>I5LTS_NY} && {randconn<{globalconnprob}})
        ...
        if ({dexE==I5LTS_NX} && {randconn<{globalconnprob}} && {dexS<I5LTS_NY} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && {dexE==I5LTS_NX} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        ...
        if ( {dexE<I5LTS_NX} && {dexS==I5LTS_NY} && {randconn<{globalconnprob}} &&{ {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}} } ) //for nodal edge

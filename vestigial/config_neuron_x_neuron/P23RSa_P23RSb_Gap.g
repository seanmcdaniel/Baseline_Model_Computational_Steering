...
echo P23RSa - P23RSb Gap Junctions
...
for (i=0;i<=(P23RSa_NY-1);i=i+1)
    for (j=0;j<=(P23RSa_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P23RSanet/P23RSa[{conn1dex}]/{conn1loc} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc} /P23RSanet/P23RSa[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P23RSanet/P23RSa[{conn1dex}]/{conn1loc} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc} /P23RSanet/P23RSa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P23RSa_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P23RSanet/P23RSa[{conn1dex}]/{conn1loc} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc} /P23RSanet/P23RSa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P23RSa_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P23RSanet/P23RSa[{conn1dex}]/{conn1loc} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P23RSbnet/P23RSb[{conn2dex}]/{conn2loc} /P23RSanet/P23RSa[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

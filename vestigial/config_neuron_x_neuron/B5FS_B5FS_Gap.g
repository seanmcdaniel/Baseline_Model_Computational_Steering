...
float globalconnprob=0.078 //after Traub 2005
float randconn
int jnodedex,inodedex,jnodecalc

echo B5FS - B5FS Gap Junctions

for (i=0;i<=(B5FS_NY-1);i=i+1)
    for (j=0;j<=(B5FS_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            conn1dex=i*B5FS_NX+j
            conn2dex=(i-1)*B5FS_NX+j
        ...
        if ({dexN>=0} && {dexE<B5FS_NX} && {randconn<{globalconnprob}})
            conn1dex=i*B5FS_NX+j
            conn2dex=(i-1)*B5FS_NX+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE<B5FS_NX} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*B5FS_NX+j
            conn2dex=(B5FS_NY-1)*B5FS_NX+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==B5FS_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner

            conn1dex=i*B5FS_NX+j
            conn2dex=(B5FS_NY-1)*B5FS_NX
        ...
        if ( {dexE==B5FS_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge

            conn1dex=i*B5FS_NX+j
            conn2dex=(i-1)*B5FS_NX
        ...
        if ({dexE<B5FS_NX} && {randconn<{globalconnprob}})
            conn1dex=i*B5FS_NX+j
            conn2dex=(i)*B5FS_NX+j+1
        ...
        if ({dexE==B5FS_NX} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexE<B5FS_NX} && {dexS>B5FS_NY} && {randconn<{globalconnprob}})
        ...
        if ({dexE==B5FS_NX} && {randconn<{globalconnprob}} && {dexS<B5FS_NY} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS==B5FS_NY} && {randconn<{globalconnprob}} && {dexE==B5FS_NX} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        ...
        if ( {dexE<B5FS_NX} && {dexS==B5FS_NY} && {randconn<{globalconnprob}} &&{ {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}} } ) //for nodal edge

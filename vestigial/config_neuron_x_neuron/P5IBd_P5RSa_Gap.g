...
for (i=0;i<=(P5IBd_NY-1);i=i+1)
    for (j=0;j<=(P5RSa_NX-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg@{{mynode} - {sqrtNnodes}} /P5RSanet/P5RSa[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBd_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5RSanet/P5RSa[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P5IBd_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg@{{mynode} + 1} /P5RSanet/P5RSa[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

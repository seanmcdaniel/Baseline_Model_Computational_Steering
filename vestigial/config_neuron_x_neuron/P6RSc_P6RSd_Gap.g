...
echo P6RSc - P6RSd Gap Junctions
...
for (i=0;i<=(P6RSc_NY-1);i=i+1)
    for (j=0;j<=(P6RSd_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P6RScnet/P6RSc[{conn1dex}]/{conn1loc} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc} /P6RScnet/P6RSc[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P6RScnet/P6RSc[{conn1dex}]/{conn1loc} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc} /P6RScnet/P6RSc[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P6RSc_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P6RScnet/P6RSc[{conn1dex}]/{conn1loc} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc} /P6RScnet/P6RSc[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P6RSc_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P6RScnet/P6RSc[{conn1dex}]/{conn1loc} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P6RSdnet/P6RSd[{conn2dex}]/{conn2loc} /P6RScnet/P6RSc[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

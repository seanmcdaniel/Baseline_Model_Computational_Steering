...
echo P5IBb - P5IBd Gap Junctions
...
for (i=0;i<=(P5IBb_NY-1);i=i+1)
    for (j=0;j<=(P5IBd_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBb_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P5IBb_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

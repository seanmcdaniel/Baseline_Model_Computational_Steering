...
echo P6RSb - P6RSb Gap Junctions
...
for (i=0;i<=(P6RSb_NY-1);i=i+1)
    for (j=0;j<=(P6RSb_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            addmsg /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            raddmsg /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P6RSb_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            raddmsg /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P6RSb_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            raddmsg /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSbnet/P6RSb[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

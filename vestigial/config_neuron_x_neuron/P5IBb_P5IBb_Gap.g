...
echo P5IBb - P5IBb Gap Junctions

for (i=0;i<=(P5IBb_NY-1);i=i+1)
    for (j=0;j<=(P5IBb_NX-1);j=j+1)
        ...
        if ({dexN>=0} && {randconn<{globalconnprob}})
            ...
            conn2dex=(i-1)*P5IBb_NX+j

            conn1loc="axonLa"
            conn2loc="axonRa"

            addmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc}  RAXIAL {Rgap} Vm
            addmsg /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} RAXIAL {Rgap} Vm

        end

        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*P5IBb_NX+j
            conn2dex=(P5IBb_NY-1)*P5IBb_NX+j

            conn1loc="axonLa"
            conn2loc="axonRa"

            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE<P5IBb_NX} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            conn1dex=i*P5IBb_NX+j
            conn2dex=(P5IBb_NY-1)*P5IBb_NX+j+1
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBb_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            conn1dex=i*P5IBb_NX+j
            conn2dex=(P5IBb_NY-1)*P5IBb_NX

            conn1loc="axonLa"
            conn2loc="axonRa"

            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc}@{{mynode} - {sqrtNnodes} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
        ...
        if ( {dexE==P5IBb_NX} && {dexN>-1} && {randconn<{globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            conn1dex=i*P5IBb_NX+j
            conn2dex=(i-1)*P5IBb_NX

            conn1loc="axonLa"
            conn2loc="axonRa"

            raddmsg /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc}@{{mynode} + 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P5IBbnet/P5IBb[{conn2dex}]/{conn2loc} /P5IBbnet/P5IBb[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm

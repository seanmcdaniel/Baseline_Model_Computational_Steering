...
echo P23RSb - P23FRBa Gap Junctions
...
for (i=0;i<=(P23RSb_NY-1);i=i+1)
    for (j=0;j<=(P23RSb_NX-1);j=j+1)
        ...
        if ({dexN == -1} && {randconn < {globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            conn1dex=i*P23RSb_NX+j
            conn2dex=(P23RSb_NY-1)*P23RSb_NX + j
        ...
        if ({dexN >= 0} && {dexE < (P23RSb_NX-1)} && {randconn < {globalconnprob}})

            conn1dex=i*P23RSb_NX+j
            conn2dex=(i-1)*P23RSb_NX+j+1
        ...
        if ({dexN == -1} && {randconn < {globalconnprob}} && {dexE < (P23RSb_NX-1)} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
 
            conn1dex=i*P23RSb_NX+j
            conn2dex=(P23RSb_NY-1)*P23RSb_NX+j+1
        ...
        if ({dexN == -1} && {randconn < {globalconnprob}} && {dexE >= P23RSb_NX-1} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner

            conn1dex=i*P23RSb_NX+j
            conn2dex=(P23RSb_NY-1)*P23RSb_NX
        ...
        if ( {dexE >= P23RSb_NX-1} && {dexN > -1} && {randconn < {globalconnprob}} &&{ {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge

            conn1dex=i*P23RSb_NX+j
            conn2dex=(i-1)*P23RSb_NX
        ...
        if ({dexE < P23RSb_NX-1} && {randconn < {globalconnprob}})

            conn1dex=i*P23RSb_NX+j
            conn2dex=(i)*P23RSb_NX+j+1
        ...
        if ({dexE >= P23RSb_NX-1} && {randconn < {globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge

            conn1dex=i*P23RSb_NX+j
            conn2dex=i*P23RSb_NX
        ...
        if ({dexE < (P23RSb_NX-1) } && {dexS < (P23RSb_NY-1) } && {randconn<{globalconnprob}})
        ...
        if ({dexE >= (P23RSb_NX-1)} && {randconn < {globalconnprob}} && {dexS < (P23RSb_NY-1)} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS >= P23RSb_NY-1} && {randconn < {globalconnprob}} && {dexE >= P23RSb_NX-1} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        ...
        if ( {dexE < P23RSb_NX-1} && {dexS >= P23RSb_NY-1} && {randconn < {globalconnprob}} &&{ {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}} } ) //for nodal edge
        ...
        if ({dexS < {P23RSb_NY-1}} && {randconn < {globalconnprob}})
        ...
        if ({dexS >= P23RSb_NY-1} && {randconn < {globalconnprob}} && { {mynode} >= {sqrtNnodes}*{sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS < P23RSb_NY-1} && {dexW >= 0} && {randconn<{globalconnprob}})
        ...
        if ({dexE == 1} && {randconn < {globalconnprob}} && {dexS < P23RSb_NY-1} && { {jnodedex} > 0 }) //for nodal edge

            conn1dex=i*P23RSb_NX+j
            conn2dex=(i+2)*P23RSb_NX-1
        ...
        if ({dexS >= P23RSb_NY-1} && {randconn < {globalconnprob}} && {dexE <= 2} && { {jnodedex} > 0 }) //for nodal edge corner

            conn1dex=i*P23RSb_NX+j
            conn2dex=P23RSb_NX-1
        ...
        if ( {dexE > 2} && {dexS >= P23RSb_NY-1} && {randconn < {globalconnprob}} &&{ {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}} } ) //for nodal edge
        ...
        if ({dexN == -1} && {randconn < {globalconnprob}} && {dexE <= 2} && { {mynode} >= {sqrtNnodes} } && { {jnodedex} > 0 }) //for nodal edge corner
            ...
            conn1dex=i*P23RSb_NX+j
            conn2dex=(P23RSb_NY*P23RSb_NX)-1

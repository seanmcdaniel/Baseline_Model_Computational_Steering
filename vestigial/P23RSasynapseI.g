...
// Specifically for P23RSa synaptic currents

echo P23RSa Synaptic Currents - LFP Setup !!!!!!!!!!!!!!!!!!!!!
echo
...
//Load synapse location array, P23RS - P23RSa AMPA
...
//str locationsP23RS = "apobproxLa"

//addmsg /P23RSanet/P23RSa[50]/apobproxLa/Ex_ch1P23RSAMPA LFPsynmodcent CURRENT Ik 0.0

for (k=0;k<={kmax};k=k+1)

     foreach s ({arglist {locationsP23RS}})

          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P23RSAMPA LFPsynmodcent CURRENT Ik 0.0
...
//Load synapse location array, P23RS - P23RSa NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP23RS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P23RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, B23FS - P23RSa GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsB23FS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Inh_ch1B23FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P5IB - P23RSa AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP5IB}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P5IBAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P5IB - P23RSa NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP5IB}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P5IBNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P6RS - P23RSa AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP6RS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P6RSAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, P6RS - P23RSa NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsP6RS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1P6RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, C23FS - P23RSa GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsC23FS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Inh_ch1C23FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, C5FS - P23RSa GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsC5FS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Inh_ch1C5FSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, ST4RS - P23RSa AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsST4RS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1ST4RSAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, ST4RS - P23RSa NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsST4RS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1ST4RSNMDA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, I23LTS - P23RSa GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsI23LTS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Inh_ch1I23LTSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, I5LTS - P23RSa GABAa
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsI5LTS}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Inh_ch1I5LTSGABAa LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, TCR - P23RSa AMPA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsTCR}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1TCRAMPA LFPsynmodcent CURRENT Ik 0.0

     end

end

//Load synapse location array, TCR - P23RSa NMDA
...
for (k=0;k<={kmax};k=k+1)
     ...
     foreach s ({arglist {locationsTCR}})
          ...
          addmsg /P23RSanet/P23RSa[{k}]/{s}/Ex_ch1TCRNMDA LFPsynmodcent CURRENT Ik 0.0

...
echo Making connections from the P6RSa cells to the I5LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_I5LTS_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSa->I5LTS connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_I5LTS_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_I5LTS longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P6RSc_B5FS_destlim}
...
echo Making connections from the P6RSc cells to the B5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability {{shortrangeprobscale}*{P6RSc_B5FS_prob}}
...
echo Setting weights and delays for P6RSc->B5FS connections.
...
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_B5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P6RSAMPA {P6RSc_B5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P6RSNMDA {P6RSc_B5FS_syndelay} -add

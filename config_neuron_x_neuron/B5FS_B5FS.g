...
float destlim = {B5FS_B5FS_destlim}
...
echo Making connections from the B5FS cells to the B5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /B5FSnet/B5FS[]/soma/spk10  \
	      /B5FSnet/B5FS[]/{s}/Inh_ch10B5FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{B5FS_B5FS_prob}}

end

echo Setting weights and delays for B5FS->B5FS connections.
...
barrierall //ayu
rvolumedelay /B5FSnet/B5FS[]/soma/spk10 -radial  {B5FS_B5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Inh_ch10B5FSGABAa {B5FS_B5FS_syndelay} -add

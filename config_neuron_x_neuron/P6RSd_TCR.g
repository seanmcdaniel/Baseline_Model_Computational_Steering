...
float destlim = {P6RSd_TCR_destlim}
...
echo Making connections from the P6RSd cells to the TCR cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability {{shortrangeprobscale}*{P6RSd_TCR_prob}}
...
echo Setting weights and delays for P6RSd->TCR connections.
...
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -fixed  {P6RSd_TCR_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSAMPA {P6RSd_TCR_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSNMDA {P6RSd_TCR_syndelay} -add

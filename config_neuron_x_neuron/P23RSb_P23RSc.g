...
float destlim = {P23RSb_P23RSc_destlim}
...
echo Making connections from the P23RSb cells to the P23RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSb_P23RSc_prob}}
...
echo Setting weights and delays for P23RSb->P23RSc connections.
...
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_P23RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P23RSAMPA {P23RSb_P23RSc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P23RSNMDA {P23RSb_P23RSc_syndelay} -add

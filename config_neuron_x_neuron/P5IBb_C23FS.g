...
float destlim = {P5IBb_C23FS_destlim}
...
echo Making connections from the P5IBb cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability {{shortrangeprobscale}*{P5IBb_C23FS_prob}}
...
echo Setting weights and delays for P5IBb->C23FS connections.
...
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P5IBAMPA {P5IBb_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P5IBNMDA {P5IBb_C23FS_syndelay} -add

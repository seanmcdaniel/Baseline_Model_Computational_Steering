...
float destlim = {P5IBa_P5IBb_destlim}
...
echo Making connections from the P5IBa cells to the P5IBb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability {{shortrangeprobscale}*{P5IBa_P5IBb_prob}}
...
echo Setting weights and delays for P5IBa->P5IBb connections.
...
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P5IBb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBAMPA {P5IBa_P5IBb_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBNMDA {P5IBa_P5IBb_syndelay} -add

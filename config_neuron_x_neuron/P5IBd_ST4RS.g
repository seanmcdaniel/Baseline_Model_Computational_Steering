...
float destlim = {P5IBd_ST4RS_destlim}
...
echo Making connections from the P5IBd cells to the ST4RS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability {{shortrangeprobscale}*{P5IBd_ST4RS_prob}}
...
echo Setting weights and delays for P5IBd->ST4RS connections.
...
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_ST4RS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P5IBAMPA {P5IBd_ST4RS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /ST4RSnet/ST4RSy[]/{s}/Ex_ch17P5IBNMDA {P5IBd_ST4RS_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSd_P6RSd_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4longrange -radial {{P23RSd_P6RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSd_P6RSd longrangeweight is {longrangeweight}
barrierall //ayu

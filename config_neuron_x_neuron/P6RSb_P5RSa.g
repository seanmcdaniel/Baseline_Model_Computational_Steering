...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_P5RSa_prob}}
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P5RSa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSAMPA {P6RSb_P5RSa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSNMDA {P6RSb_P5RSa_syndelay} -add

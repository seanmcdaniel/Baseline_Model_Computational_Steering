...
float destlim = {B23FS_B23FS_destlim}
...
echo Making connections from the B23FS cells to the B23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /B23FSnet/B23FS[]/soma/spk5  \
	      /B23FSnet/B23FS[]/{s}/Inh_ch5B23FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{B23FS_B23FS_prob}}

end

echo Setting weights and delays for B23FS->B23FS connections.

...
echo Making connections from the P5IBd cells to the P23RSd cells.
...
echo Setting weights and delays for P5IBd->P23RSd connections.
...
echo P5IBd_P23RSd longrangeweight is {longrangeweight}
barrierall //ayu

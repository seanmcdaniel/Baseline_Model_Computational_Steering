...
float destlim = {P6RSc_P5IBc_destlim}
...
echo Making connections from the P6RSc cells to the P5IBc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability {{shortrangeprobscale}*{P6RSc_P5IBc_prob}}
...
echo Setting weights and delays for P6RSc->P5IBc connections.
...
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_P5IBc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSAMPA {P6RSc_P5IBc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSNMDA {P6RSc_P5IBc_syndelay} -add

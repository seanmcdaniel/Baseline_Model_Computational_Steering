...
echo Making connections from the P23RSc cells to the I5LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSc_I5LTS_prob}}
...
echo Setting weights and delays for P23RSc->I5LTS connections.

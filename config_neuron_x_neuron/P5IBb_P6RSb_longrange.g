...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBb_P6RSb_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7longrange -radial {{P5IBb_P6RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBb_P6RSb longrangeweight is {longrangeweight}
barrierall //ayu

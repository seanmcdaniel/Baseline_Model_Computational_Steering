...
//float destlim = {P5IBb_P6RSc_destlim}
...
echo Making connections from the P5IBb cells to the P6RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBb_P6RSc_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBb->P6RSc connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7longrange -radial {{P5IBb_P6RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBb_P6RSc longrangeweight is {longrangeweight}
barrierall //ayu

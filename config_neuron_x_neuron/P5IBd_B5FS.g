...
float destlim = {P5IBd_B5FS_destlim}
...
echo Making connections from the P5IBd cells to the B5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBAMPA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{P5IBd_B5FS_prob}}
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBNMDA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P5IBd->B5FS connections.
...
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_B5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBAMPA {P5IBd_B5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBNMDA {P5IBd_B5FS_syndelay} -add

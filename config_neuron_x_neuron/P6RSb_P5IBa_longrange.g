...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSb_P5IBa_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12longrange -radial {{P6RSb_P5IBa_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSb_P5IBa longrangeweight is {longrangeweight}
barrierall //ayu

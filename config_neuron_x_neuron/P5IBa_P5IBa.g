...
float destlim = {P5IBa_P5IBa_destlim}
...
echo Making connections from the P5IBa cells to the P5IBa cells.
...
echo Setting weights and delays for P5IBa->P5IBa connections.
...
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P5IBa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBAMPA {P5IBa_P5IBa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBNMDA {P5IBa_P5IBa_syndelay} -add

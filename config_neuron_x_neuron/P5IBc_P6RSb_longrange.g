...
//float destlim = {P5IBc_P6RSb_destlim}
...
echo Making connections from the P5IBc cells to the P6RSb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBc_P6RSb_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBc->P6RSb connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8longrange -radial {{P5IBc_P6RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBc_P6RSb longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P23RSa_P23RSb_destlim}
...
echo Making connections from the P23RSa cells to the P23RSb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSa_P23RSb_prob}}
...
echo Setting weights and delays for P23RSa->P23RSb connections.
...
barrierall //ayu
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_P23RSb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P23RSAMPA {P23RSa_P23RSb_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P23RSNMDA {P23RSa_P23RSb_syndelay} -add

...
float destlim = {P5IBa_C5FS_destlim}
...
echo Making connections from the P5IBa cells to the C5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
	      /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBAMPA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{P5IBa_C5FS_prob}}
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
	      /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBNMDA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P5IBa->C5FS connections.
...
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_C5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBAMPA {P5IBa_C5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBNMDA {P5IBa_C5FS_syndelay} -add

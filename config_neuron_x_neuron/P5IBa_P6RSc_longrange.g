...
//float destlim = {P5IBa_P6RSc_destlim}
...
echo Making connections from the P5IBa cells to the P6RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBa_P6RSc_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBa->P6RSc connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6longrange -radial {{P5IBa_P6RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBa_P6RSc longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P5IBd_P5IBb_destlim}
...
echo Making connections from the P5IBd cells to the P5IBb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
	      /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBAMPA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{P5IBd_P5IBb_prob}}
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
	      /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBNMDA@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
echo Setting weights and delays for P5IBd->P5IBb connections.
...
volumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P5IBb_axdelayCV} -add -gaussian {P5IBd_P5IBb_axdelaystdev} {P5IBd_P5IBb_axdelaymaxdev}
...
volumeweight /P5IBdnet/P5IBd[]/soma/spk9 -decay {P5IBdecayrate} {P5IBmaxwgt} {P5IBminwgt}

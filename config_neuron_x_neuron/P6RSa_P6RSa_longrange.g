...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_P6RSa_prob}}
          //-probability 0.5
...
//    barrierall //ayu
//    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
//	      /P6RSanet/P6RSa[]/{s}/Inh_ch11P6RSGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_P6RSa_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_P6RSa longrangeweight is {longrangeweight}
barrierall //ayu

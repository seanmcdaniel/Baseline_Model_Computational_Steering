...
//float destlim = {P5IBd_I23LTS_destlim}
...
echo Making connections from the P5IBd cells to the I23LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBd_I23LTS_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P5IBd->I23LTS connections.

// assigning delays
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9longrange -radial {{P5IBd_I23LTS_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBd_I23LTS longrangeweight is {longrangeweight}
barrierall //ayu

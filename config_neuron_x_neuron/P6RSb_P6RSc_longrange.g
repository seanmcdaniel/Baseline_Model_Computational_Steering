...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSb_P6RSc_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12longrange -radial {{P6RSb_P6RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSb_P6RSc longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P23RSc_P23RSa_destlim}
...
echo Making connections from the P23RSc cells to the P23RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSc_P23RSa_prob}}
...
echo Setting weights and delays for P23RSc->P23RSa connections.
...
barrierall //ayu
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3 -radial  {P23RSc_P23RSa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSAMPA {P23RSc_P23RSa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSNMDA {P23RSc_P23RSa_syndelay} -add

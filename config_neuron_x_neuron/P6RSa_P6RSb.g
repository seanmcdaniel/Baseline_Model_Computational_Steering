...
float destlim = {P6RSa_P6RSb_destlim}
...
echo Making connections from the P6RSa cells to the P6RSb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
          ...
          -probability {{shortrangeprobscale}*{P6RSa_P6RSb_prob}}
...
echo Setting weights and delays for P6RSa->P6RSb connections.
...
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P6RSb_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RSbnet/P6RSb[]/{s}/Ex_ch12P6RSAMPA {P6RSa_P6RSb_syndelay} -add

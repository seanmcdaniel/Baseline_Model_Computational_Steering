...
float destlim = {P5IBc_P5RSa_destlim}
...
echo Making connections from the P5IBc cells to the P5RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability {{shortrangeprobscale}*{P5IBc_P5RSa_prob}}
...
echo Setting weights and delays for P5IBc->P5RSa connections.
...
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5RSa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBAMPA {P5IBc_P5RSa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBNMDA {P5IBc_P5RSa_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_I5LTS_prob}}
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_I5LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSAMPA {P6RSb_I5LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSNMDA {P6RSb_I5LTS_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSc_P23FRBa_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13longrange -radial {{P6RSc_P23FRBa_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSc_P23FRBa longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {C23FS_P6RSc_destlim}
...
echo Making connections from the C23FS cells to the P6RSc cells.

// C23FS - P6RSc GABAa

barrierall //ayu
rvolumeconnect /C23FSnet/C23FS[]/soma/spk15  \
	      /P6RScnet/P6RSc[]/axona/Inh_ch13C23FSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{C23FS_P6RSc_prob}}

echo Setting weights and delays for C23FS->P6RSc connections.

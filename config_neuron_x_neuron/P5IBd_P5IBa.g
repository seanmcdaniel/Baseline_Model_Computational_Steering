...
float destlim = {P5IBd_P5IBa_destlim}
...
echo Making connections from the P5IBd cells to the P5IBa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability {{shortrangeprobscale}*{P5IBd_P5IBa_prob}}
...
echo Setting weights and delays for P5IBd->P5IBa connections.
...
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P5IBa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBAMPA {P5IBd_P5IBa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBNMDA {P5IBd_P5IBa_syndelay} -add

...
float destlim = {I5LTS_P5RSa_destlim}
...
echo Making connections from the I5LTS cells to the P5RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /P5RSanet/P5RSa[]/{s}/Inh_ch23I5LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I5LTS_P5RSa_prob}}

end

echo Setting weights and delays for I5LTS->P5RSa connections.
...
barrierall //ayu
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_P5RSa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5RSanet/P5RSa[]/{s}/Inh_ch23I5LTSGABAa {I5LTS_P5RSa_syndelay} -add

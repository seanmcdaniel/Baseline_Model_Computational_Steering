...
float destlim = {P6RSb_I23LTS_destlim}
...
echo Making connections from the P6RSb cells to the I23LTS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_I23LTS_prob}}
...
echo Setting weights and delays for P6RSb->I23LTS connections.
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_I23LTS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P6RSAMPA {P6RSb_I23LTS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P6RSNMDA {P6RSb_I23LTS_syndelay} -add

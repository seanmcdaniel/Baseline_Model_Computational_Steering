...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9longrange  \
          ...
          -probability {{longrangeprobscale}*{P5IBd_P23RSc_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9longrange -radial {{P5IBd_P23RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P5IBd_P23RSc longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P5IBc_P5IBc_destlim}
...
echo Making connections from the P5IBc cells to the P5IBc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability {{shortrangeprobscale}*{P5IBc_P5IBc_prob}}
...
echo Setting weights and delays for P5IBc->P5IBc connections.
...
barrierall //ayu
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5IBc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5IBAMPA {P5IBc_P5IBc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5IBNMDA {P5IBc_P5IBc_syndelay} -add

...
float destlim = {P6RSb_P5IBa_destlim}
...
echo Making connections from the P6RSb cells to the P5IBa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability {{shortrangeprobscale}*{P6RSb_P5IBa_prob}}
...
echo Setting weights and delays for P6RSb->P5IBa connections.
...
barrierall //ayu
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P5IBa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P6RSAMPA {P6RSb_P5IBa_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P6RSNMDA {P6RSb_P5IBa_syndelay} -add

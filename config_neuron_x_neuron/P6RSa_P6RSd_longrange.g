...
//float destlim = {P6RSa_P6RSd_destlim}
...
echo Making connections from the P6RSa cells to the P6RSd cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_P6RSd_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSa->P6RSd connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_P6RSd_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSa_P6RSd longrangeweight is {longrangeweight}
barrierall //ayu

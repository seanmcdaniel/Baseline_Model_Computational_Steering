...
//float destlim = {P6RSd_P6RSc_destlim}
...
echo Making connections from the P6RSd cells to the P6RSc cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSd_P6RSc_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSd->P6RSc connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P6RSc_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSd_P6RSc longrangeweight is {longrangeweight}
barrierall //ayu

...
float destlim = {P23RSb_C5FS_destlim}
...
echo Making connections from the P23RSb cells to the C5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSb_C5FS_prob}}
...
echo Setting weights and delays for P23RSb->C5FS connections.
...
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_C5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P23RSAMPA {P23RSb_C5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P23RSNMDA {P23RSb_C5FS_syndelay} -add

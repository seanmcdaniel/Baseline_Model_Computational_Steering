...
//float destlim = {P6RSd_P23RSb_destlim}
...
echo Making connections from the P6RSd cells to the P23RSb cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSd_P23RSb_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSd->P23RSb connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P23RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P6RSd_P23RSb longrangeweight is {longrangeweight}
barrierall //ayu

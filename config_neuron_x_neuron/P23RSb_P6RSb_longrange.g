...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSb_P6RSb_prob}}
          //-probability 0.5
...
// assigning delays
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2longrange -radial {{P23RSb_P6RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSb_P6RSb longrangeweight is {longrangeweight}
barrierall //ayu

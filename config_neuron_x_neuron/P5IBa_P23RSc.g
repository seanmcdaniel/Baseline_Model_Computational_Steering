...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability {{shortrangeprobscale}*{P5IBa_P23RSc_prob}}
...
barrierall //ayu
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P23RSc_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P5IBAMPA {P5IBa_P23RSc_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P5IBNMDA {P5IBa_P23RSc_syndelay} -add

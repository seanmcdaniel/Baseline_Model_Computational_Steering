...
float destlim = {I5LTS_P23FRBa_destlim}
...
echo Making connections from the I5LTS cells to the P23FRBa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /P23FRBanet/P23FRBa[]/{s}/Inh_ch22I5LTSGABAa@{regionnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {{shortrangeprobscale}*{I5LTS_P23FRBa_prob}}

end

echo Setting weights and delays for I5LTS->P23FRBa connections.
...
barrierall //ayu
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_P23FRBa_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Inh_ch22I5LTSGABAa {I5LTS_P23FRBa_syndelay} -add

...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1longrange  \
          ...
          -probability {{longrangeprobscale}*{P23RSa_P23RSb_prob}}
          //-probability 0.5
...
//    barrierall //ayu
//    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1longrange  \
//	      /P23RSbnet/P23RSb[]/{s}/Inh_ch2P23RSGABAa@{distantnodes}	    \
//	      -relative			    \
//	      -sourcemask box -1 -1  -1  1  1  1  \
//	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
//	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
// assigning delays
barrierall //ayu
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1longrange -radial {{P23RSa_P23RSb_axdelayCV}*{longrangeCVscale}} -add
...
echo P23RSa_P23RSb longrangeweight is {longrangeweight}
barrierall //ayu

...
//float destlim = {P6RSa_P5RSa_destlim}
...
echo Making connections from the P6RSa cells to the P5RSa cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
          ...
          -probability {{longrangeprobscale}*{P6RSa_P5RSa_prob}}
          //-probability 0.5
...
echo Setting weights and delays for P6RSa->P5RSa connections.

// assigning delays
barrierall //ayu
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_P5RSa_axdelayCV}*{longrangeCVscale}} -add

...
float destlim = {P23RSa_B5FS_destlim}
...
echo Making connections from the P23RSa cells to the B5FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSa_B5FS_prob}}
...
echo Setting weights and delays for P23RSa->B5FS connections.
...
barrierall //ayu
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_B5FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSAMPA {P23RSa_B5FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSNMDA {P23RSa_B5FS_syndelay} -add

...
float destlim = {P23RSd_C23FS_destlim}
...
echo Making connections from the P23RSd cells to the C23FS cells.
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSd_C23FS_prob}}
...
echo Setting weights and delays for P23RSd->C23FS connections.
...
barrierall //ayu
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_C23FS_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSAMPA {P23RSd_C23FS_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P23RSNMDA {P23RSd_C23FS_syndelay} -add

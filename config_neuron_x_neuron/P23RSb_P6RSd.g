...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability {{shortrangeP23probscale}*{P23RSb_P6RSd_prob}}
...
barrierall //ayu
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_P6RSd_axdelayCV} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P23RSAMPA {P23RSb_P6RSd_syndelay} -add
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P23RSNMDA {P23RSb_P6RSd_syndelay} -add
